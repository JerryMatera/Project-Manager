...
fun ProjectScreen(
    ...
    when {
        state.createTask -> {
            ...
            if (state.archiveProjectSuccess) {
                navHostController.popBackStack()
            }

            if (state.archiveProjectError.isNotEmpty()) {
                Dialog(onDismissRequest = { performEvent(ProjectUIEvent.UpdateArchiveProjectError("")) }) {
                    Card(
                        ...
                        Text(
                            text = state.archiveProjectError,
                        ...
                        actions = {
                            ...
                            DropdownMenu(
                                ...
                                DropdownMenuItem(
                                    ...
                                    text = { Text("Archives") },
                                    onClick = { performEvent(ProjectUIEvent.ArchiveProject) },
                                )
                            }
                        }
                    )
